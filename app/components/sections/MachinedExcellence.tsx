...
export default function MachinedExcellence() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative z-30 w-full bg-gradient-to-b from-gray-50 to-white"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
        ...
        <div
          className={`flex flex-col lg:flex-row justify-between items-start lg:items-end mb-8 sm:mb-12 lg:mb-16 transition-all duration-700 delay-100 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
        >
          <div className="max-w-2xl mb-6 lg:mb-0">
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-gray-800 mb-3 sm:mb-6 tracking-tight">
              Machined Excellence
            </h2>
          ...
          <Link
            href="/gallery"
            className="group flex items-center gap-2 sm:gap-3 text-primary font-bold mt-4 lg:mt-0 hover:text-primary-hover transition-colors"
          >
        ...
        <div
          className={`grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 transition-all duration-700 delay-200 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
        >
          <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden h-64 sm:h-80 lg:h-[500px] group shadow-xl">
            ...
            <div className="absolute bottom-4 left-4 right-4 sm:bottom-8 sm:left-8 sm:right-10">
              <div className="text-[10px] sm:text-xs tracking-[0.2em] text-primary mb-1 sm:mb-2 uppercase font-bold">
                Technique
              </div>
          ...
          <div className="flex flex-col gap-4 sm:gap-6">
            <div className="grid grid-cols-2 gap-4 sm:gap-6">
              <div className="relative bg-gradient-to-br from-gray-100 to-gray-50 rounded-2xl p-6 sm:p-8 sm:p-10 flex flex-col justify-center overflow-hidden group hover:shadow-xl transition-all duration-300 border border-gray-200">
                <div className="text-4xl sm:text-5xl lg:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-br from-primary to-yellow-400 mb-2 sm:mb-4">
                  0.02
                </div>
                <div className="font-bold text-gray-800 text-sm sm:text-base lg:text-lg mb-1">
                  Precision
                </div>
